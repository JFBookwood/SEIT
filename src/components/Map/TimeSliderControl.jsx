...
function TimeSliderControl({ 
  ...
  return (
    <div className="bg-white dark:bg-neutral-800 rounded-lg shadow-lg p-3 max-w-sm mx-auto">
      {/* Time Display */}
      ...
      <div className="flex items-center justify-center space-x-2 mb-3">
        <button
          ...
          className="p-1.5 rounded bg-neutral-100 dark:bg-neutral-700 hover:bg-neutral-200 dark:hover:bg-neutral-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
        ...
        <div className="flex items-center space-x-1 ml-2">
          ...
          <select
            ...
            className="px-1 py-0.5 text-xs border border-neutral-300 dark:border-neutral-600 rounded bg-white dark:bg-neutral-700 text-neutral-900 dark:text-white"
          >
      ...
      <div className="mb-3">
        <input
          ...
          className="w-full h-1.5 bg-neutral-200 rounded appearance-none cursor-pointer slider"
        />
      ...
      {onPrecomputeSnapshots && (
        <div className="pt-2 border-t border-neutral-200 dark:border-neutral-700">
          <button
            ...
            className="w-full px-2 py-1.5 text-xs bg-primary-50 dark:bg-primary-900/20 hover:bg-primary-100 dark:hover:bg-primary-900/30 rounded border border-primary-200 dark:border-primary-800 text-primary-600 transition-colors"
          >
